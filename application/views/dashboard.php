  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg" style="height: 70px;">
            ...
            <!--logo start-->
            <a href="<?= base_url() ?>index.html" class="logo" style="margin-top: 10px;"><h2>Hello <?php echo $_SESSION['username'];?></h2></a>
            <!--logo end-->
           
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href='<?php echo base_url(); ?>index.php/Login/logoutUser' style="height:30px;">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              <!-- sidebar menu start-->
              <ul class="sidebar-menu" id="nav-accordion" style="margin-top: 100px;">
              
              	  <p class="centered" ><a href="profile.html"><img src="<?= base_url() ?>assets/img/C1.png" class="img-circle " width="80"></a></p>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h1 class="centered">DATA PENJUALAN</h1>
                  	...
                  	<div class="row mtbox">
                  		<div class="col-md-2 col-sm-2 col-md-offset-1 box0">
                  			<div class="box1">
					  			...
					  			<p>933 Orang menyukai halaman Anda 24 jam terakhir. Whoohoo!</p>
                  		</div>
                  		...
                  		<div class="col-md-2 col-sm-2 box0">
                  			<div class="box1">
					  			...
					  			<p>Server Anda berfungsi dengan baik. Santai & nikmati.</p>
                  		</div>
                      	...
                      	<div class="col-md-4 col-sm-4 mb">
                      		<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
                                  <a href="<?= base_url() ?>index.php/Home/utama"><img src="<?= base_url() ?>assets/img/B1.jpg" width="120" class="img-circle " width="80"></a>
      ...
      *********************************************************************************************************************************************************** -->                  
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	<div class="thumb">
                      		<img class="<?= base_url() ?>img-circle" src="assets/img/ui-divya.jpg" width="35px" height="35px" align="">
                      	</div>
                      	<div class="details">
